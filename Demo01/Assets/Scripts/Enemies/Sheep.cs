...
public class Sheep : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        RaycastHit2D rayHit = Physics2D.Raycast(frontVec, Vector3.down, 3f, LayerMask.GetMask("Platform"));
    ...
    {
        player = GameObject.Find("Player").GetComponent<Player>();
        ItemDatabase.instance.ItemDrop(gameObject.transform.position, 22);
        Destroy(gameObject);
    }
}
